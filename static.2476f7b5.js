...
function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};var ownKeys=Object.keys(source);if(typeof Object.getOwnPropertySymbols==='function'){ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable;}));}ownKeys.forEach(function(key){_defineProperty(target,key,source[key]);});}return target;}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}function _objectWithoutProperties(source,excluded){if(source==null)return{};var target=_objectWithoutPropertiesLoose(source,excluded);var key,i;if(Object.getOwnPropertySymbols){var sourceSymbolKeys=Object.getOwnPropertySymbols(source);for(i=0;i<sourceSymbolKeys.length;i++){key=sourceSymbolKeys[i];if(excluded.indexOf(key)>=0)continue;if(!Object.prototype.propertyIsEnumerable.call(source,key))continue;target[key]=source[key];}}return target;}function _objectWithoutPropertiesLoose(source,excluded){if(source==null)return{};var target={};var sourceKeys=Object.keys(source);var key,i;for(i=0;i<sourceKeys.length;i++){key=sourceKeys[i];if(excluded.indexOf(key)>=0)continue;target[key]=source[key];}return target;}var style={margin:'5% 10%',boxSizing:'border-box'};function Sponsors(_ref){var platinum=_ref.platinum,gold=_ref.gold,silver=_ref.silver;return external_react_default.a.createElement(react_layout_grid_["Grid"],null,external_react_default.a.createElement(react_layout_grid_["Row"],null,external_react_default.a.createElement(react_layout_grid_["Cell"],null,external_react_default.a.createElement(react_typography_["Headline2"],null,"Sponsors"))),external_react_default.a.createElement(react_layout_grid_["Row"],null,platinum.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:8,style:style},SponsorBanner(toSponsor(sponsor)));})),external_react_default.a.createElement(react_layout_grid_["Row"],null,gold.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:3,desktopColumns:6,style:style},SponsorBanner(toSponsor(sponsor)));})),external_react_default.a.createElement(react_layout_grid_["Row"],null,silver.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:2,desktopColumns:3,style:style},SponsorBanner(toSponsor(sponsor)));})));}function toSponsor(_ref2){var banner=_ref2.banner,url=_ref2.url,args=_objectWithoutProperties(_ref2,["banner","url"]);return _objectSpread({src:banner,href:url},args);}
