...
const EventDate = () => <div>{eventDate}</div>

const mapUrl = 'https://goo.gl/maps/V6S6EQTARUE2'
const Place = props => (
  <div {...props}>
    <a href={mapUrl}>サテライトキャンパスひろしま 501</a>
  </div>
)

const themeText = 'いまさらチームビルディング'
const EventTheme = () => <div>{themeText}</div>
const EventName = () => (
  <div>
    <Grid>オープンセミナー</Grid>
    <Grid>2018@広島</Grid>
...
const EntryPageButton = () => (
  <a href="https://osh.connpass.com/event/69092/">
    <Button>申し込みページへ</Button>
  </a>
)

export default () => (
  <Banner px={[20, 25]} py={[40, 120]} color="white">
    <Box f={[5, 6]}>
      <EventName />
    </Box>
    <Box f={[3, 5]}>
