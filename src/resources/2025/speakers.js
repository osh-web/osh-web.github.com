...
export const S_O_F_Science: Speaker = {
  ...
  memberships: [],
  session: {
    name: '「昔からこのやり方なので…」から脱却するには？ ローカル業務をSaaSに変え、組織の"当たり前"をアップデートした方法',
    description: '「いつからか続くこの業務手順、本当に今のベストなのだろうか？」\n' +
      '「新しいSaaSを導入して業務を効率化したいが、新しいツールやシステムが使われない、浸透しない…」\n' +
      '\n' +
      '多くの現場でこのような課題が日々生まれています。このセッションでは、旧来のローカル環境での業務をSaaSへと移行し、定着させるまで、私たちが「実際に実施したこと」を具体的にお話しします。',
  },
  twitter: '',
}
