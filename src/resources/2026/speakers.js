...
export const nakagawara: Speaker = {
  ...
  memberships: [],
  session: {
    name: '一人情シスでもDXは推進できる〜社内コミュニティという選択肢〜',
    description:
      '中小企業では、情シスやDX推進を他業務と兼務するケースが多く、ITツールを導入しても各職場の利活用支援まで手が回らず、業務改善・業務変革まで結びつかないことも多くあると思います。\n' +
      'その課題を解決する一つの手段として、「社内コミュニティ」を作りDXを推進してきた実践例を紹介します。',
  },
  twitter: '',
}
