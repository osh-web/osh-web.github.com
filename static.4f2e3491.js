...
var orangesystem={name:'株式会社 オレンジシステム広島',key:'orangesystem',url:'https://www.orange.co.jp/',banner:'/img/2019/orangesystem.svg'};var cybozu={name:'サイボウズ株式会社',key:'cyboz',url:'https://cybozu.co.jp/',banner:'/img/2019/cybozu.svg'};var platinum=[orangesystem,cybozu];var shuaruta={name:'株式会社シュアルタ',key:'shuaruta',url:'https://shuaruta.com/',banner:'/img/2019/shuaruta.svg'};var gold=[shuaruta];var pmaj={name:'日本プロジェクトマネジメント協会',key:'pmaj',url:'http://www.pmaj.or.jp/',banner:'/img/2018/pmaj.png'};var nextvision={name:'株式会社ネクストビジョン',key:'nextvision',url:'https://www.nextvision.co.jp/',banner:'/img/2018/nextvision.png'};var silver=[pmaj,nextvision];var sponsors={platinum:platinum,gold:gold,silver:silver};
...
function SponsorBanner(_ref){var name=_ref.name,href=_ref.href,src=_ref.src,fit=_ref.fit;return external_react_default.a.createElement("a",{href:href},external_react_default.a.createElement("img",{src:src,alt:"".concat(name," \u30D0\u30CA\u30FC"),style:{objectFit:'contain',width:"100%",height:150}}));}
// CONCATENATED MODULE: /Users/cw-himura/ghq/github.com/osh-web/osh-web.github.com/src/organisms/2019/Sponsors.js
function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};var ownKeys=Object.keys(source);if(typeof Object.getOwnPropertySymbols==='function'){ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable;}));}ownKeys.forEach(function(key){_defineProperty(target,key,source[key]);});}return target;}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}function _objectWithoutProperties(source,excluded){if(source==null)return{};var target=_objectWithoutPropertiesLoose(source,excluded);var key,i;if(Object.getOwnPropertySymbols){var sourceSymbolKeys=Object.getOwnPropertySymbols(source);for(i=0;i<sourceSymbolKeys.length;i++){key=sourceSymbolKeys[i];if(excluded.indexOf(key)>=0)continue;if(!Object.prototype.propertyIsEnumerable.call(source,key))continue;target[key]=source[key];}}return target;}function _objectWithoutPropertiesLoose(source,excluded){if(source==null)return{};var target={};var sourceKeys=Object.keys(source);var key,i;for(i=0;i<sourceKeys.length;i++){key=sourceKeys[i];if(excluded.indexOf(key)>=0)continue;target[key]=source[key];}return target;}function Sponsors(_ref){var platinum=_ref.platinum,gold=_ref.gold,silver=_ref.silver;return external_react_default.a.createElement(react_layout_grid_["Grid"],null,external_react_default.a.createElement(react_layout_grid_["Row"],null,external_react_default.a.createElement(react_layout_grid_["Cell"],null,external_react_default.a.createElement(react_typography_["Headline2"],null,"Sponsors"))),external_react_default.a.createElement(react_layout_grid_["Row"],null,platinum.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:8},SponsorBanner(toSponsor(sponsor)));})),external_react_default.a.createElement(react_layout_grid_["Row"],null,gold.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:3,desktopColumns:6},SponsorBanner(toSponsor(sponsor)));})),external_react_default.a.createElement(react_layout_grid_["Row"],null,silver.map(function(sponsor){return external_react_default.a.createElement(react_layout_grid_["Cell"],{columns:2,desktopColumns:3},SponsorBanner(toSponsor(sponsor)));})));}function toSponsor(_ref2){var banner=_ref2.banner,url=_ref2.url,args=_objectWithoutProperties(_ref2,["banner","url"]);return _objectSpread({src:banner,href:url},args);}
...
//# sourceMappingURL=static.4f2e3491.js.map